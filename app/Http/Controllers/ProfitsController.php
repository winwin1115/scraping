...
class ProfitsController extends Controller
{
    ...
    public function makeDoc($output, $href, $currency_rate, $profit_rate)
    {
        ...
        $real_price = '';
        $price_array = [];
        $price_temp = $pokemon_xpath->query('//div[@class="Price Price--buynow"]//div[@class="Price__borderBox"]//dl[@class="Price__body Price__body--none "]//dd[@class="Price__value"]/font()');
        dd($price_temp);
